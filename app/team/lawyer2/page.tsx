...
const Lawyer2Page = () => {
  const currentLawyer = {
    ...
    speciality: '민사소송, 부동산',
    experience: '12년',
    education: ['연세대학교 법학과 졸업', '사법연수원 38기 수료'],
    career: [
      '법무법인 정의 파트너변호사 (2018~현재)',
      '서울중앙지법 민사조정위원 (2020~현재)',
      '태평양 법률사무소 시니어변호사 (2015~2018)',
      '법무법인 광장 변호사 (2012~2015)'
    ],
    achievements: [
      '2022년 서울지방변호사회 공익활동 표창',
      '2020년 민사소송 승소율 95% 달성',
      '부동산 분쟁 전문변호사 인증'
    ],
    cases: [
      '대형 건설분쟁 승소 (배상금 100억원)',
      '재개발 조합 관련 집단소송 대리',
      '부동산 투자 사기 피해 구제'
    ],
    philosophy: '의뢰인의 입장에서 생각하고, 법리적 정확성과 실무적 경험을 바탕으로 최선의 결과를 위해 노력합니다. 특히 부동산 분쟁에서는 감정적 대립보다는 합리적 해결을 추구합니다.',
    contact: {
      phone: '02-1234-5679',
      email: 'lee.lawyer@lawfirm-justice.co.kr'
    }
  };

  const otherLawyers = [
    { name: '김법무', url: '/team/lawyer1', speciality: '기업법무, M&A' },
    { name: '박송무', url: '/team/lawyer3', speciality: '형사변호, 교통사고' }
  ];
        ...
        >
          <div className="flex flex-col lg:flex-row items-start space-y-6 lg:space-y-0 lg:space-x-8">
            <div className="w-full lg:w-1/3">
              <div className="w-full h-80 bg-gradient-to-br from-green-400 to-green-600 rounded-lg flex items-center justify-center">
            ...
            <div className="w-full lg:w-2/3">
              ...
              <p className="text-xl text-green-600 font-semibold mb-3">{currentLawyer.position}</p>
            ...
            <div className="space-y-4">
              {currentLawyer.education.map((edu, index) => (
                <div key={index} className="flex items-start p-4 bg-gray-50 rounded-lg">
                  <ChevronRight className="w-5 h-5 text-green-600 mt-1 mr-3" />
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {otherLawyers.map((lawyer, index) => (
              ...
              >
                ...
                <div className="mt-4 text-green-600 font-medium group-hover:translate-x-2 transition-transform inline-flex items-center">
