...
const Lawyer1Page = () => {
  const currentLawyer = {
    ...
    speciality: '기업법무, M&A',
    experience: '15년',
    education: ['서울대학교 법학과 졸업', '하버드 로스쿨 LL.M'],
    career: [
      '법무법인 정의 대표변호사 (2015~현재)',
      '대한변호사협회 기업법무분과 위원장 (2018~2020)',
      '김앤장 법률사무소 파트너변호사 (2010~2015)',
      '삼성전자 법무팀 선임변호사 (2008~2010)'
    ],
    achievements: [
      '2023년 대한변호사협회 우수변호사상 수상',
      '2021년 아시아 로 어워드 M&A 부문 최우수상',
      '2019년 국정감사 증인 출석 (기업지배구조 관련)'
    ],
    cases: [
      '국내 대기업 해외진출 M&A 자문 (500억원 규모)',
      '외국인투자 관련 정부승인 취득',
      '상장기업 지배구조 개선 컨설팅'
    ],
    philosophy: '기업의 지속가능한 성장을 법률적으로 뒷받침하는 것이 저의 사명입니다. 복잡한 법적 이슈를 명확하고 실용적인 해결책으로 제시하여 고객의 비즈니스 성공에 기여하고자 합니다.',
    contact: {
      phone: '02-1234-5678',
      email: 'kim.lawyer@lawfirm-justice.co.kr'
    }
  };
        ...
        >
          <div className="flex flex-col lg:flex-row items-start space-y-6 lg:space-y-0 lg:space-x-8">
            ...
            <div className="w-full lg:w-2/3">
              ...
              <p className="text-xl text-blue-600 font-semibold mb-3">{currentLawyer.position}</p>
